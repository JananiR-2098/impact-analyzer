...
// angular:jit:template:src\app\graph\graph.html
var graph_default;
var init_graph = __esm({
  "angular:jit:template:src\\app\\graph\\graph.html"() {
    graph_default = `<ngx-graph\r
  class="graph-container"\r
  [nodes]="nodes"\r
  [links]="links"\r
  [layout]="'dagre'"\r
  [curve]="curve"\r
  (nodeClick)="onNodeClick($event)"\r
  (linkClick)="onLinkClick($event)"\r
>\r
\r
  <!-- Node Template -->\r
  <ng-template #nodeTemplate let-node>\r
    <svg:g>\r
       <circle\r
      [attr.r]="20"\r
      [attr.cx]="20"\r
      [attr.cy]="20"\r
      [attr.fill]="node.data?.critical ? '#d9534f' : '#3f51b5'">\r
    </circle>\r
\r
\r
      <svg:text\r
...
\r
  <!-- Link Template -->\r
  <ng-template #linkTemplate let-link>\r
    <svg:g>\r
      <svg:path\r
        [attr.d]="link.line"\r
        stroke="#888"\r
...
\r
      <svg:text text-anchor="middle" dy="-6" font-size="11">\r
        {{ link.label }}\r
      </svg:text>\r
    </svg:g>\r
  </ng-template>\r
...
// angular:jit:style:src\app\graph\graph.css
var graph_default2;
var init_graph2 = __esm({
  "angular:jit:style:src\\app\\graph\\graph.css"() {
    graph_default2 = "/* src/app/graph/graph.css */\n.graph-container svg {\n  pointer-events: none !important;\n}\n.graph-container {\n  width: 100%;\n  height: 500px;\n}\n/*# sourceMappingURL=graph.css.map */\n";
  }
});

// node_modules/@swimlane/ngx-graph/node_modules/tslib/tslib.es6.mjs
...
var init_animations = __esm({
  "node_modules/@angular/animations/fesm2022/animations.mjs"() {
    ...
    AnimationBuilder = class _AnimationBuilder {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.12", ngImport: core_exports, type: _AnimationBuilder, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.12", ngImport: core_exports, type: _AnimationBuilder, providedIn: "root", useFactory: () => inject(BrowserAnimationBuilder) });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.12", ngImport: core_exports, type: AnimationBuilder, decorators: [{
      type: Injectable,
    ...
    BrowserAnimationBuilder = class _BrowserAnimationBuilder extends AnimationBuilder {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.12", ngImport: core_exports, type: _BrowserAnimationBuilder, deps: [{ token: RendererFactory2 }, { token: DOCUMENT }], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.12", ngImport: core_exports, type: _BrowserAnimationBuilder, providedIn: "root" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.12", ngImport: core_exports, type: BrowserAnimationBuilder, decorators: [{
      type: Injectable,
...
var require_build_layer_graph = __commonJS({
  "node_modules/dagre/lib/order/build-layer-graph.js"(exports, module) {
    ...
    function buildLayerGraph(g, rank, relationship) {
      var root2 = createRootNode(g), result = new Graph3({ compound: true }).setGraph({ root: root2 }).setDefaultNodeLabel(function(v) {
        return g.node(v);
      });
      _.forEach(g.nodes(), function(v) {
...
var require_bk = __commonJS({
  "node_modules/dagre/lib/position/bk.js"(exports, module) {
    ...
    function buildBlockGraph(g, layering, root2, reverseSep) {
      var blockGraph = new Graph3(), graphLabel = g.graph(), sepFn = sep(graphLabel.nodesep, graphLabel.edgesep, reverseSep);
      _.forEach(layering, function(layer) {
        var u;
        _.forEach(layer, function(v) {
          var vRoot = root2[v];
...
var require_powergraph = __commonJS({
  "node_modules/webcola/dist/src/powergraph.js"(exports) {
    ...
    function toGroups(modules, group2, groups) {
      modules.forAll(function(m2) {
        if (m2.isLeaf()) {
          if (!group2.leaves)
            group2.leaves = [];
...
var require_rbtree = __commonJS({
  "node_modules/webcola/dist/src/rbtree.js"(exports) {
    ...
    var Iterator2 = (function() {
      ...
      Iterator3.prototype.data = function() {
      ...
      ;
      Iterator3.prototype.prev = function() {
        if (this._cursor === null) {
          var root2 = this._tree._root;
          if (root2 !== null) {
            this._maxNode(root2);
      ...
      ;
      Iterator3.prototype._minNode = function(start2) {
      ...
      ;
      Iterator3.prototype._maxNode = function(start2) {
...
var require_rectangle = __commonJS({
  "node_modules/webcola/dist/src/rectangle.js"(exports) {
    ...
    function generateGroupConstraints(root2, f, minSep, isContained) {
      ...
      if (isContained) {
        var b = root2.bounds, c2 = f.getCentre(b), s = f.getSize(b) / 2, open = f.getOpen(b), close = f.getClose(b), min = c2 - s + padding / 2, max = c2 + s - padding / 2;
      ...
      if (ln)
        root2.leaves.forEach(function(l) {
...
var require_handledisconnected = __commonJS({
  "node_modules/webcola/dist/src/handledisconnected.js"(exports) {
    ...
    function applyPacking(graphs, w, h, node_size, desired_ratio, centerGraph) {
      ...
      var init_x3 = 0, init_y3 = 0, svg_width = w, svg_height = h, desired_ratio = typeof desired_ratio !== "undefined" ? desired_ratio : 1, node_size = typeof node_size !== "undefined" ? node_size : 0, real_width = 0, real_height = 0, min_width = 0, global_bottom = 0, line = [];
      if (graphs.length == 0)
        return;
      calculate_bb(graphs);
      ...
      function put_rect(rect, max_width) {
        ...
        if (rect.y + rect.height - real_height > -packingOptions.FLOAT_EPSILON)
          real_height = rect.y + rect.height - init_y3;
        if (rect.x + rect.width - real_width > -packingOptions.FLOAT_EPSILON)
          real_width = rect.x + rect.width - init_x3;
      }
      ;
...
var dagre, import_webcola, cache, PanningAxis, MiniMapPosition, colorSets, ColorHelper, VisibilityObserver, Orientation, Alignment, DagreLayout, DagreClusterLayout, DEFAULT_EDGE_NAME, EDGE_KEY_DELIM, DagreNodesOnlyLayout, D3ForceDirectedLayout, ColaForceDirectedLayout, layouts, LayoutService, MouseWheelDirective, NgxGraphStates, GraphComponent, GraphModule, NgxGraphModule;
var init_swimlane_ngx_graph = __esm({
  "node_modules/@swimlane/ngx-graph/fesm2022/swimlane-ngx-graph.mjs"() {
    "use strict";
    init_core();
    init_core();
    ...
    init_src10();
    init_src13();
    dagre = __toESM(require_dagre(), 1);
    init_src15();
    init_src15();
    import_webcola = __toESM(require_dist(), 1);
    init_src5();
    init_src6();
    cache = {};
    ...
    VisibilityObserver = class _VisibilityObserver {
      element;
      zone;
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _VisibilityObserver, deps: [{ token: ElementRef }, { token: NgZone }], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "18.1.5", type: _VisibilityObserver, selector: "visibility-observer", outputs: { visible: "visible" }, ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: VisibilityObserver, decorators: [{
      type: Directive,
      args: [{
        // tslint:disable-next-line:directive-selector
        selector: "visibility-observer"
      }]
    }], ctorParameters: () => [{ type: ElementRef }, { type: NgZone }], propDecorators: { visible: [{
      type: Output
    }] } });
    ...
    ColaForceDirectedLayout = class {
      ...
      run(graph) {
        ...
        this.internalGraph = {
          nodes: [
            ...this.inputGraph.nodes.map((n) => __spreadProps(__spreadValues({}, n), {
      ...
      internalGraphToOutputGraph(internalGraph) {
        ...
        this.outputGraph.clusters = internalGraph.groups.map((group2, index2) => {
    ...
    LayoutService = class _LayoutService {
      getLayout(name) {
        if (layouts[name]) {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _LayoutService, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _LayoutService });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: LayoutService, decorators: [{
      type: Injectable
    }] });
    MouseWheelDirective = class _MouseWheelDirective {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _MouseWheelDirective, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "18.1.5", type: _MouseWheelDirective, selector: "[mouseWheel]", outputs: { mouseWheelUp: "mouseWheelUp", mouseWheelDown: "mouseWheelDown" }, host: { listeners: { "mousewheel": "onMouseWheelChrome($event)", "DOMMouseScroll": "onMouseWheelFirefox($event)", "wheel": "onWheel($event)", "onmousewheel": "onMouseWheelIE($event)" } }, ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: MouseWheelDirective, decorators: [{
      type: Directive,
    ...
    GraphComponent = class _GraphComponent {
      el;
      zone;
      cd;
      layoutService;
...
`, styles: [".minimap .minimap-background{fill:#0000001a}.minimap .minimap-drag{fill:#0003;stroke:#fff;stroke-width:1px;stroke-dasharray:2px;stroke-dashoffset:2px;cursor:pointer}.minimap .minimap-drag.panning{fill:#0000004d}.minimap .minimap-nodes{opacity:.5;pointer-events:none}.graph{-webkit-user-select:none;user-select:none}.graph .edge{stroke:#666;fill:none}.graph .edge .edge-label{stroke:none;font-size:12px;fill:#251e1e}.graph .panning-rect{fill:#0000;cursor:move}.graph .node-group.old-node{transition:transform .5s ease-in-out}.graph .node-group .node:focus{outline:none}.graph .compound-node rect{opacity:.5}.graph .cluster rect{opacity:.2}\n"], dependencies: [{ kind: "directive", type: NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "directive", type: MouseWheelDirective, selector: "[mouseWheel]", outputs: ["mouseWheelUp", "mouseWheelDown"] }], animations: [
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: GraphComponent, decorators: [{
      type: Component,
...
`, styles: [".minimap .minimap-background{fill:#0000001a}.minimap .minimap-drag{fill:#0003;stroke:#fff;stroke-width:1px;stroke-dasharray:2px;stroke-dashoffset:2px;cursor:pointer}.minimap .minimap-drag.panning{fill:#0000004d}.minimap .minimap-nodes{opacity:.5;pointer-events:none}.graph{-webkit-user-select:none;user-select:none}.graph .edge{stroke:#666;fill:none}.graph .edge .edge-label{stroke:none;font-size:12px;fill:#251e1e}.graph .panning-rect{fill:#0000;cursor:move}.graph .node-group.old-node{transition:transform .5s ease-in-out}.graph .node-group .node:focus{outline:none}.graph .compound-node rect{opacity:.5}.graph .cluster rect{opacity:.2}\n"] }]
    }], ctorParameters: () => [{ type: ElementRef }, { type: NgZone }, { type: ChangeDetectorRef }, { type: LayoutService }], propDecorators: { nodes: [{
      type: Input
    }], clusters: [{
      type: Input
    }], compoundNodes: [{
    ...
    GraphModule = class _GraphModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _GraphModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "18.1.5", ngImport: core_exports, type: _GraphModule, declarations: [GraphComponent, MouseWheelDirective, VisibilityObserver], imports: [CommonModule], exports: [GraphComponent, MouseWheelDirective] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _GraphModule, providers: [LayoutService], imports: [CommonModule] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: GraphModule, decorators: [{
      type: NgModule,
      args: [{
    ...
    NgxGraphModule = class _NgxGraphModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _NgxGraphModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "18.1.5", ngImport: core_exports, type: _NgxGraphModule, imports: [CommonModule], exports: [GraphModule] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: _NgxGraphModule, imports: [CommonModule, GraphModule] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.1.5", ngImport: core_exports, type: NgxGraphModule, decorators: [{
      type: NgModule,
      args: [{
        imports: [CommonModule],
        exports: [GraphModule]
...
var init_graph3 = __esm({
  "src/app/graph/graph.ts"() {
    ...
    Graph = class Graph2 {
      ...
      sanitizeId(id3) {
        return id3.replaceAll(/[^a-zA-Z0-9_-]/g, "_");
      }
      ngOnChanges() {
        if (!this.graph)
          return;
        ...
        this.links = this.graph.links.filter((l) => nodeIds.has(l.source) && nodeIds.has(l.target)).map((l) => ({
    ...
    Graph = __decorate([
      Component({
        ...
        standalone: true,
        template: graph_default,
        styles: [graph_default2]
      })
    ], Graph);
  }
});
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ETWESAIJ.js.map
